...
public class ReportService {
    ...
    public Map<String, Object> getTripReport(LocalDate from, LocalDate to) {
        ...
        report.put("totalTrips",
                tripRepository.countByCreatedAtBetween(start, end));
        ...
        report.put("totalExpenses",
                expenseRepository.sumInDateRange(from, to));
    ...
    public Map<String, Object> getVehicleUtilizationReport() {
        ...
        report.put("availableVehicles",
                vehicleRepository.countByStatus(com.tms.enums.VehicleStatus.AVAILABLE));
        report.put("busyVehicles",
                vehicleRepository.countByStatus(com.tms.enums.VehicleStatus.BUSY));
        report.put("maintenanceVehicles",
                vehicleRepository.countByStatus(com.tms.enums.VehicleStatus.MAINTENANCE));
    ...
    public Map<String, Object> getDriverPerformanceReport() {
        ...
        report.put("activeDrivers",
                driverRepository.countByStatus(com.tms.enums.DriverStatus.ACTIVE));
        report.put("inactiveDrivers",
                driverRepository.countByStatus(com.tms.enums.DriverStatus.INACTIVE));
